...
namespace Gallery
{
    ...
    public partial class MainWindow : Window
    {
        ...
        Panel SamplePanel;
        ContentControl SampleContainer1;
        ContentControl SampleContainer2;

        FrameworkElement SampleOffset;
        FrameworkElement SelectorBar;
        ToggleButton SelectorExpanderButton;
        ...
        private void InitializeComponent()
        {
            ...
            this.SampleContainer1 = (ContentControl)FindName("SampleContainer1");
            this.SampleContainer2 = (ContentControl)FindName("SampleContainer2");

            this.SampleOffset = (FrameworkElement)FindName("SampleOffset");
            this.SelectorBar = (FrameworkElement)FindName("SelectorBar");
            this.SelectorExpanderButton = (ToggleButton)FindName("SelectorExpanderButton");
        }
        ...
        private static class Application
        {
            ...
            {
                return Noesis.GUI.LoadXaml(uri.OriginalString);
            }
        }

        private static class DesignerProperties
        {
            public static bool GetIsInDesignMode(FrameworkElement element)
            {
                return false;
            }
        }
