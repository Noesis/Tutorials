...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            lookAction.AddCompositeBinding("OneModifier").With("Binding", "<Mouse>/delta").With("Modifier", "<Mouse>/rightButton");
            lookAction.AddBinding("<Gamepad>/rightStick").WithProcessor("scaleVector2(x=15, y=15)");
            lookAction.AddBinding("<XRController>{RightHand}/thumbstick").WithProcessor("scaleVector2(x=15, y=15)");
            ...
            movementAction.AddBinding("<XRController>{LeftHand}/thumbstick");
