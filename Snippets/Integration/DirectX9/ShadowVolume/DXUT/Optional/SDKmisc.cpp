                                    ...
                                    __in WCHAR* strExeName )
{
    ...
    // Search in the %EXE_DIR%\..\Data\Packages\Gui\Tutorials\Content\Integration\DX9\ShadowVolume
    swprintf_s( strSearchPath, cchSearch, L"%s\\..\\Data\\Packages\\Gui\\Tutorials\\Content\\Integration\\DX9\\ShadowVolume\\%s", strExePath, strLeaf );
    if( GetFileAttributes( strSearchPath ) != 0xFFFFFFFF )
        return true;
